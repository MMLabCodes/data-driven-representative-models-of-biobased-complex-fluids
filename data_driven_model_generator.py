...
def main():
    ...
    """
    Generate directories for the models
    Return the output directory where we can send our outputs
    
    Note: The class "make_model_dirs" can be editted to aid with other filepath management during your own DFT calculations
    """
